      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        ...
        <div className="flex-shrink-0">
          <div className="flex items-baseline gap-2">
            <span className="text-5xl font-bold">{Math.round(stats.like_percentage)}%</span>
            <span className="text-muted-foreground">liked this course</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-8">
          ...
          <div>
            <div className="text-sm text-muted-foreground mb-2">Real-World Relevance</div>
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((value) => (
                <Star
                  key={value}
